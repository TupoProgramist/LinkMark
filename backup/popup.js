document.addEventListener('DOMContentLoaded', () => {
    ...
    chrome.storage.local.get({ defaultColor: '#ff0000', markedLinks: {} }, (result) => {
      ...
      Object.keys(markedLinks).forEach(linkUrl => {
        ...
        colorPicker.addEventListener('input', () => {
          updateLinkColor(linkUrl, colorPicker.value);  // Update the color in storage when changed
  ...
  // Function to send a message to the content script to update the color in real-time
